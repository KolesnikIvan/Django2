window.onload = function () {
    ...
    //количество форм, количество товаров в заказе, суммарная цена заказа
    ...
    //создание массивов количеств, цен
    ...
    //при отсутствии на странице количества товаров оно вычисляется
    ...
    //обработка нажатий на input, number, checkbox
...
//обновление информации в форме заказа
    ...
    //кнопка добалвения продукта
    $('.formset_row').formset({ //поиск элем-в со стилем formset_row, вызов метода formset этого набора
        addText: 'add product',
        deleteText: 'delete',
        prefix: 'items',
